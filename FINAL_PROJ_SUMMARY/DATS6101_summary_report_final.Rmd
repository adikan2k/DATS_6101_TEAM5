...
The target variable, song popularity, was categorized into low, medium, and high classes, with SMOTE oversampling applied as shown below, to balance the dataset.
...
Logistic Regression was then employed to these categories. Although it improved interpretability, multicollinearity among features (e.g., energy and loudness) and an inability to distinguish medium and high classes resulted in underwhelming performance.
