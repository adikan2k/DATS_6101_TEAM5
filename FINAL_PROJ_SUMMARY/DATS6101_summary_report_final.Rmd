...
We tried to adopt methods like cook's distance, applied logarithmic transformations to handle the limitlation 
...
Although the model improved interpretability, Multicollinearity among features like energy and loudness reduced the model’s ability to accurately estimate coefficients.
...
4.The Random Forest model (final model)
