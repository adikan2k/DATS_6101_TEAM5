...
#### One-Way Anova to test if the mean values of each attribute differ significantly across clusters

```{r}

# Attributes
attributes <- c("avg_loudness", "avg_valence", "avg_danceability",  "avg_instrumentalness", "avg_acousticness", "avg_liveness")
