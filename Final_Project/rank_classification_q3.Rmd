...
Using cross validation k=3 still has the best performance and consistent having all total accuracy, specificity, sensitivity at around 85%.
...
After checking k=3 on test set, there is a larger discrepancy between specificty and sensitivity. Additionally, the cross-validation total accuracy with k=7 still give us consistent performance at around 0.7472. Therefore, we will choose k=7 as the best model. AUC 0.8136 >0.8
